namespace Estately.Infrastructure.UnitOfWorks
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        public IRepository<TblClientPropertyInterest> ClientPropertyInterestRepository { get; }
        ...
        public UnitOfWork(AppDBContext context,
            ...
            IRepository<TblClientPropertyInterest> clientPropertyInterestRepo,
            ...
            IRepository<TblZone> zoneRepo)
        {
            ...
            ClientPropertyInterestRepository = clientPropertyInterestRepo ?? throw new ArgumentNullException(nameof(clientPropertyInterestRepo));

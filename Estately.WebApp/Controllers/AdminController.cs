...
namespace Estately.WebApp.Controllers
{
    public class AdminController : Controller
    {
        ...
        {
            return RedirectToAction("Index", "TblProperties");
        }

        public IActionResult CreateProperty()
        {
            return RedirectToAction("Create", "TblProperties");
        }

        public IActionResult EditProperty(int id)
        {
            return RedirectToAction("Edit", "TblProperties", new { id });
        }

        public IActionResult DeleteProperty(int id)
        {
            return RedirectToAction("Delete", "TblProperties", new { id });
        }

        public IActionResult PropertyDetails(int id)
        {
            return RedirectToAction("Details", "TblProperties", new { id });
        }
